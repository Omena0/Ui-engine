...
Fuck complex ass layout managers we have position control :fire:



(to be honest might still add them)
...
- Button      - Text but with a rectangle around it*

- Textbox     - You can type shit*

- Image       - Displays an image that it

- Progressbar - Best progress bar you've ever seen

- Checkbox    - A Checkbox. It can be on or off that's it.*

- Slider      - Just a slider*

- Tab         - Allows you to make tabs easily

- Area        - Just colored rectangle.
...
And yes I still will do it anyway.
...
You can set the current tab with root.settable(tab)
